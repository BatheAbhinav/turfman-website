...
<html>
    ...
    <div class="page-header text-center">
        <h1>Credit/Debit Card Payment Gateway</h1>
    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group"> <label>CARD NUMBER</label>
                                        <div class="input-group"> <input type="tel" class="form-control" name="cno" placeholder="Valid Card Number" /> <span class="input-group-addon"><span class="fa fa-credit-card"></span></span> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-xs-5 col-md-5 pull-right">
                                    <div class="form-group"> <label>CVV</label> <input name="cvv" type="tel" class="form-control" placeholder="CVV" /> </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group"> <label>CARD OWNER</label> <input name="n1" type="text" class="form-control" placeholder="Card Owner Name" /> </div>
                                </div>
                                <div class="col-xs-7">
                                    <div class="form-group"><label>AMOUNT</label><br>₹500
                                    </div>
                                </div>
                            </div>
